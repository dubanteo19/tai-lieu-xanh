...
public class CommentController {
    ...
    deleteComment(@PathVariable Integer postId, @RequestBody CommentDeleteReq req) {
        commentService.deleteComment(postId, req);
        return ResponseEntity.ok("comment deleted");
    }

    @PutMapping("/post/{postId}")
    public ResponseEntity<CommentRes>
    updateComment(@PathVariable Integer postId, @RequestBody CommentUpdateReq req) {
        return ResponseEntity.ok(commentService.updateComment(postId, req));
    }

    @PostMapping("/post/{postId}")
    public ResponseEntity<CommentRes>
    saveComment(@PathVariable Integer postId, @RequestBody CommentCreateReq commentCreateReq) {
