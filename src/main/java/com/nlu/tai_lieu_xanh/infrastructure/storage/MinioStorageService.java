...
public class MinioStorageService {
  ...
  public void uploadFile(
      String bucket, String objectName, ByteArrayOutputStream baos, String contentType) {
    try {
      var object =
  ...
  public InputStream downLoadFile(String objectName) {
    try {
      var object = GetObjectArgs.builder().bucket(bucketName).object(objectName).build();
  ...
  public void deleteFile(String objectName)
      throws InvalidKeyException,
          ...
          XmlParserException,
          IOException {
    var object = RemoveObjectArgs.builder().bucket(bucketName).object(objectName).build();
  ...
  public String getFileUrl(String objectName) {
    ...
    try {
      ...
      throw new FileStorageException(
          "Could not genrerate presigned URL for object " + objectName, e);
    }
  }
}
